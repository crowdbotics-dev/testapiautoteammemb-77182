...
## Project Structure
    ...
    ├── testapiautoteammemb_77182  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_77182`
...
2. Clone this repo and `cd testapiautoteammemb_77182`
